...
Francis Ascombe created four datasets with identical linear statistics: mean, variance, correlation and regression line are identical. Their data generating processes are however very different
...
$$
\frac{\hat{\beta}-\beta}{se(\hat{\beta})} \tilde{} t(N−P)
$$
