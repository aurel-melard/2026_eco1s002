...
$$E( \hat{\beta_d} | P) = \frac{Cov(p,y)}{Var(p)} = \beta_d + \frac{Cov( \frac{ \epsilon - \mu}{\beta_s - \beta_d} , \epsilon )}{Var(p)} $$
...
-  Second stage: 
$$y_i = \alpha + \beta x_i + \epsilon_i = \alpha + \beta \hat{x}_i + \epsilon_i + \beta \hat{v}_i  = \alpha + \beta \hat{x}_i + \mu_i $$
