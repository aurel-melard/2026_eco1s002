...
A typical tip is to choose simple and short titles for the files and the scripts. For instance, this file for this class is named `tutorial1.qmd`. Your code can be named `code_tutorial1.R`. It should be self-explanatory.
